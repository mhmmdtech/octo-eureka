...
trait HasCRUD
{
    ...
    protected function deleteBySlugMethod($slug = null)
    {
        ...
        $object->setSql("DELETE FROM " . $object->getTableName());
        $object->setWhere("AND", $this->getAttributeName($this->slugColumn) . " = ? ");
    ...
    protected function whereMethod($attribute, $firstValue, $secondValue = null)
    {
        ...
        $this->setAllowedMethods(['where', 'whereOr', 'whereIn', 'whereNull', 'whereNotNull', 'limit', 'orderBy', 'get', 'paginate', 'count']);
        return $this;
    }
    ...
    protected function limitMethod($from, $number)
    {
        ...
        $this->setAllowedMethods(['limit', 'get', 'paginate', 'count', 'orderBy']);
        return $this;
    }
    ...
    protected function saveMethod()
    {
        ...
        $this->resetQuery();
        $this->setAllowedMethods(['update', 'delete', 'deleteBySlug', 'find', 'findBySlug']);
        return $this;
    }
