class MembersResetPasswordHandler {
  constructor(form) {
    this.form = form;
...
const membersResetPasswordForm = document.getElementById(
  'members-reset-password-form'
);
const membersResetPasswordHandler = new MembersResetPasswordHandler(
  membersResetPasswordForm
);
