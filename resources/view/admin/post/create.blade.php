...
<script defer src="<?= asset('admin-assets/js/pages/CreatePostHandler.js') ?>"></script>
@endsection
          ...
          >
            ...
            >
              ...
              >
                ...
                <option value="<?= $categorySelect->id ?>" class="dark-color primary-bg" <?= old('category_id') == $categorySelect->id ? 'selected' : '' ?> >
