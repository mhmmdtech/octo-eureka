...
<script defer src="<?= asset('admin-assets/js/pages/EditCategoryHandler.js') ?>"></script>
@endsection
...
<header
        ...
        >
          <form
            ...
            novalidate
            action="<?= route('admin.categories.update', ['slug' => $category->slug]) ?>" 
            method="post" 
          ...
          <input type="hidden" name="_method" value="put">
            ...
            >
              ...
              <input
                ...
                value="<?= oldOrValue('title', $category->title) ?>"
                />
              <div
            ...
            >
              ...
              >
                ...
                <option value="<?= $categorySelect->id ?>" class="dark-color primary-bg" <?= oldOrValue('parent_id', $category->parent_id) == $categorySelect->id ? 'selected' : '' ?> >
            ...
            >
              ...
              <input
                ...
                class="dashboard-form__input w-100 border-1px outline-none-attention dark-color radius-rounded-small primary-bg border-gray pd-1 font-size-1"
                value="<?= oldOrValue('description', $category->description) ?>"
                />
              <div
